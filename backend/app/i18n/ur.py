...
UI = {
    ...
    "report_btn": "تعمیل رپورٹ بنائیں",
    "print_btn": "رپورٹ پرنٹ کریں", "report_generating": "رپورٹ بن رہی ہے...",
...
REPORT_REASONS = {
    "reasons_heading": "یہ فیصلہ کیوں کیا گیا",
    "plain_verdict": "سادہ زبان میں",
    "favour_heading": "حق میں شمار کیے گئے عوامل",
    "against_heading": "خلاف شمار کیے گئے عوامل",
    "no_favour": "اس فیصلے کے حق میں کوئی عامل شمار نہیں کیا گیا۔",
    "no_against": "اس فیصلے کے خلاف کوئی عامل شمار نہیں کیا گیا۔",
    "influence_note": "ہر فیصد اس فیصلے پر اُس عامل کے کل اثر کا حصہ ہے، بڑا پہلے۔",
    "value_label": "استعمال شدہ قیمت",
    "share_label": "اثر کا حصہ",
    "strongest_factor": "سب سے بڑا واحد اثر {feature} کا تھا۔",
    "how_to_read": "یہ رپورٹ کیسے پڑھیں",
    "how_to_read_body": "ذیل کا فیصلہ ایک خودکار ماڈل نے تیار کیا ہے۔ ماڈل نے جو ہر عامل استعمال کیا، دی گئی قیمت اور اس نے نتیجے کو کتنا بدلا، اس کے ساتھ درج ہے۔ اس فہرست سے باہر کسی چیز نے نتیجے پر اثر نہیں ڈالا۔",
}
