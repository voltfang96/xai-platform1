...
REPORT_REASONS = {
    "reasons_heading": "આ નિર્ણય કેમ લેવાયો",
    "plain_verdict": "સરળ ભાષામાં",
    "favour_heading": "તરફેણમાં ગણાયેલા પરિબળો",
    "against_heading": "વિરુદ્ધમાં ગણાયેલા પરિબળો",
    "no_favour": "આ નિર્ણયની તરફેણમાં કોઈ પરિબળ ગણાયું નથી.",
    "no_against": "આ નિર્ણયની વિરુદ્ધમાં કોઈ પરિબળ ગણાયું નથી.",
    "influence_note": "પ્રત્યેક ટકાવારી આ નિર્ણય પર તે પરિબળના કુલ પ્રભાવનો હિસ્સો છે, સૌથી મોટો પ્રથમ.",
    "value_label": "વપરાયેલ મૂલ્ય",
    "share_label": "પ્રભાવનો હિસ્સો",
    "strongest_factor": "સૌથી મોટો એકલ પ્રભાવ {feature} નો હતો.",
    "how_to_read": "આ અહેવાલ કેવી રીતે વાંચવો",
    "how_to_read_body": "નીચેનો નિર્ણય સ્વયંસંચાલિત મોડેલ દ્વારા બનાવાયો છે. મોડેલે વાપરેલું પ્રત્યેક પરિબળ, આપેલું મૂલ્ય અને તેણે પરિણામને કેટલું બદલ્યું તે સાથે સૂચિબદ્ધ છે. આ સૂચિ બહારની કોઈ બાબતે પરિણામને પ્રભાવિત કર્યું નથી.",
}
